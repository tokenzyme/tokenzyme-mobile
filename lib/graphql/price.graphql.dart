...
class Query$GetEthPrice {
  Query$GetEthPrice({required this.ethPrice, this.$__typename = 'Query'});
  ...
  int get hashCode {
    final l$ethPrice = ethPrice;
    final l$$__typename = $__typename;
    return Object.hashAll([l$ethPrice, l$$__typename]);
  }
...
extension UtilityExtension$Query$GetEthPrice on Query$GetEthPrice {
  CopyWith$Query$GetEthPrice<Query$GetEthPrice> get copyWith =>
      CopyWith$Query$GetEthPrice(this, (i) => i);
}
...
abstract class CopyWith$Query$GetEthPrice<TRes> {
  ...
  TRes call({double? ethPrice, String? $__typename});
}

class _CopyWithImpl$Query$GetEthPrice<TRes>
    implements CopyWith$Query$GetEthPrice<TRes> {
  _CopyWithImpl$Query$GetEthPrice(this._instance, this._then);
...
class _CopyWithStubImpl$Query$GetEthPrice<TRes>
  ...
  call({double? ethPrice, String? $__typename}) => _res;
}

const documentNodeQueryGetEthPrice = DocumentNode(
  definitions: [
...
typedef OnQueryComplete$Query$GetEthPrice =
    FutureOr<void> Function(Map<String, dynamic>?, Query$GetEthPrice?);
...
class FetchMoreOptions$Query$GetEthPrice extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$GetEthPrice({required graphql.UpdateQuery updateQuery})
    : super(updateQuery: updateQuery, document: documentNodeQueryGetEthPrice);
}
...
extension ClientExtension$Query$GetEthPrice on graphql.GraphQLClient {
  ...
  ]) async => await this.query(options ?? Options$Query$GetEthPrice());
